        ...
        <div className="flex flex-col xl:flex-row gap-x-8">
          <div className="text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
            ...
            <motion.p variants={fadeIn("up", 0.4)} initial="hidden" animate="show" exit="hidden" className="mb-4 max-w-[400px] mx-auto lg:mx-0">
              Tailored to your specific needs, I specialize in creating custom software solutions. Whether you require a web application, desktop software, or mobile app, I have the expertise to bring your ideas to life
            </motion.p>
          </div>
