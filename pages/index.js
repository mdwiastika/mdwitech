  ...
  return (
    <div className="bg-primary/60 h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        <motion.div className="bg-none xl:bg-explosion xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0" variants={fadeIn("up", 0.1)} initial="hidden" animate="show" exit="hidden" transition={{ duration: 0.5, ease: "easeInOut" }}></motion.div>
        <ParticlesContainer />
